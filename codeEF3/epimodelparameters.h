...
class EpiModelParameters {
 public:
  ...
  double getKnownPositiveFraction() { return fKnownPositiveFraction;}
  double getKnownPositiveIsolation(){ return fknownPositiveIsolation;}
  int getSampledSize() {return sampledSize;}
    int getSampledDay(){return sampledDay;}
    int getPoolSize() {return poolSize;}
  double getAVEiSampled() {return AVEiSampled;}
  ...
  enum antiviralPolicy getAVPolicySampled() { return eAntiviralPolicySampled; }
  ...
  double getQuarantineComplianceSampled() { return fQuarantineComplianceSampled; }
 ...
 protected:
  ...
  int sampledDay;
  int poolSize;
  enum antiviralPolicy eAntiviralPolicySampled; // how to distribute antivirals in sampled people
  double AVEiSampled; // less likely to infect others
  double fQuarantineComplianceSampled;     // probability of individual compliance (set to
